...
async function getContracts () {
  try {
    // let response= await fetch("http://localhost:3000/kpis/contracts");
    let response= await fetch("https://www.assa-abloy-contract-manager.com/kpis/contracts");
...
async function getUsers () {
  try {
    // let response= await fetch("http://localhost:3000/kpis/users");
    let response= await fetch("https://www.assa-abloy-contract-manager.com/kpis/users");
